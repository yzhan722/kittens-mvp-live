  ...
  return function renderHelp() {
    ...
    rows.push(`
      <div class="row">
        <div class="row__left">
          ...
          <div class="row__desc muted">版本 v0.39.1 · 点击各节标题展开详情</div>
        </div>
      </div>
    `);
    ...
    rows.push(block("🚀 快速开始", `
      <div style="line-height:1.9">
        <b>① 营地（篝火）</b>：点【采集】获取树果 → 建造${h('树果田')}和${h('球果营地')} → 资源自动产出${br}
        <b>② 研究</b>：消耗资源解锁科技，优先研究提升精灵球上限的科技${br}
        <b>③ 捕捉</b>：有精灵球就去抓精灵，组建强大队伍${br}
        <b>④ 功能</b>：训练精灵提升等级，送精灵远征赚未来币${br}
        <b>⑤ 循环</b>：用未来币购买全服Buff → 资源更多 → 建筑更强 → 继续收集
      </div>
      ${tip('精灵球不够？先升级球果营地，再研究「精灵球容量」科技。')}
    `, true));
